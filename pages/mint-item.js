    ...
    return (
        <div className='flex justify-center' style={{justifyContent:'center'}}>
            <div className='w-1/2 flex flex-col pb-12'>
                <input style={{borderRadius:'.5em', paddingRight:'5em'}}
                ...
                /> {
                fileUrl && (
                    <img className='rounded mt-4' style={{minWidth:'400px',maxWidth:'400px',minHeight:'400px',maxHeight:'400px'}} src={fileUrl} />
                )}
