...
export default function Home() {
  ...
  return (
    <div className='home' style={{backgroundColor:'white'}}>
          ...
          <div style={{backgroundColor:'white'}} className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4'>
            {
              nfts.map((nft, i)=>(
                <div key={i} className='border shadow rounded-x1 overflow-hidden'>
                  <img src={nft.image} style={{minWidth:'400px',maxWidth:'400px',minHeight:'400px',maxHeight:'400px'}}/>
                  <div className='p-4'>
